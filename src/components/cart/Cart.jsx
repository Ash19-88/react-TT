      ...
      <div className="container text-center my-5">
        ...
        <section id="cart" className={styles.cartContainer}>
          <table className="table">
            <thead>
              <tr>
                <th className={styles.tableHead} scope="col">Producto</th>
                <th className={styles.tableHead} scope="col">Precio</th>
                <th className={styles.tableHead} scope="col">Cantidad</th>
                <th className={styles.tableHead} scope="col">Subtotal</th>
            ...
            {items.map((item, index) => (
              <tr key={index} className={styles.cartItem}>
                ...
                <td className={styles.tableData}>{item.quantity || 1}</td>
                <td className={styles.tableData}>${item.price * (item.quantity || 1)}</td>
                <td className={styles.tableData}>
                  <button onClick={() => clearCart(item.id)} className={styles.trashButton}><BsTrash3 size={18}/></button>
                </td>
              </tr>
            ))}
            </tbody>
